...
am__append_6 = -I$(PYTHIA8_DIR)/include  -I$(ROOTINC)
#am__append_7 = -L$(PYTHIA8_DIR)/lib/archive -lpythia8 -llhapdfdummy -lpythia8tohepmc
#am__append_8 = -DPYTHIA8180_OR_LATER
am__append_9 = -L$(PYTHIA8_DIR)/lib/archive -lpythia8 -llhapdfdummy -lhepmcinterface  $(ROOTLIBS) 
...
ACLOCAL = ${SHELL} /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/config/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/config/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/config/missing --run autoconf
AUTOHEADER = ${SHELL} /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/config/missing --run autoheader
AUTOMAKE = ${SHELL} /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/config/missing --run automake-1.11
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPPFLAGS = -I/home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/pythia8/176//include -I/home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/lhapdf-5.9.1/workdir//include -I/home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/HepMC-2.06.05/workdir/include  $(am__append_8)
CXX = g++
CXXCPP = g++ -E
...
GREP = /bin/grep
HAS_ROOT_CONFIG = 
HEPMC_DIR = /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/HepMC-2.06.05/workdir
INSTALL = /usr/bin/install -c
INSTALL_DATA = ${INSTALL} -m 644
INSTALL_PROGRAM = ${INSTALL}
INSTALL_SCRIPT = ${INSTALL}
INSTALL_STRIP_PROGRAM = $(install_sh) -c -s
LD = /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/gcc/6.3.0/x86_64-unknown-linux-gnu/bin/ld -m elf_x86_64
LDFLAGS = 
LIBOBJS = 
LIBS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/config/missing --run makeinfo
MCTESTER_DIR = 
MKDIR_P = /bin/mkdir -p
NM = /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/gcc/6.3.0/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
...
PATH_SEPARATOR = :
PYTHIA8_DIR = /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/pythia8/176/
RANLIB = ranlib
ROOTINC = /cvmfs/cms.cern.ch/slc6_amd64_gcc630/cms/cmssw/CMSSW_9_3_8/external/slc6_amd64_gcc630/bin/../../../../../../../slc6_amd64_gcc630/lcg/root/6.10.04-ghjeda/include
ROOTLIBS = -L/cvmfs/cms.cern.ch/slc6_amd64_gcc630/cms/cmssw/CMSSW_9_3_8/external/slc6_amd64_gcc630/bin/../../../../../../../slc6_amd64_gcc630/lcg/root/6.10.04-ghjeda/lib  $(shell root-config --glibs)
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/sh
STRIP = strip
VERSION = 1.0.6
abs_builddir = /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/examples
abs_srcdir = /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/examples
abs_top_builddir = /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5
abs_top_srcdir = /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
ac_ct_F77 = gfortran
...
install_sh = ${SHELL} /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/config/install-sh
...
pdfdir = ${docdir}
prefix = /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/workdir
...
top_builddir = ..
top_srcdir = ..
with_lhapdf = /home/vladimircherepanov/TauPol/pythia8setup/install/tauola++/1.1.5/lhapdf-5.9.1/workdir/
